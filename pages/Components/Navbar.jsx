...
const Navbar = ({ setTheme, theme }) => {
  return (
    <>
      <div className="flex justify-between text-gray-800 dark:text-slate-200 py-6 md:py-9 lg:py-11 z-30 relative">
        <div className="font-light text-2xl">
          VJ<sup>th</sup>
        </div>
        <div className="flex gap-4 md:gap-6 lg:gap-8 items-center sm:text-sm md:text-base lg:text-lg">
          <a
            href="https://docs.google.com/document/d/1AglclbhNABpTcusWhRZ6M0AgVQNROTS8u6nOKkG7ws4/edit?usp=sharing"
            target="_blank"
